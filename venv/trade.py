from rms import stoploss_at_order
import data_1m
import data_5m
import stocklist
import macd_logic
...
def order(tradingsymbol,transaction_type,order_type,quantity):
    ...
    price = data_1m.quoteMoneyControl(tradingsymbol)
    stoploss_at_order(tradingsymbol,transaction_type,order_type,quantity,price)
